...
mcp = FastMCP(
    "fortress-dashboard",
    instructions=(
        "Fortress Dashboard MCP v4.2.0 — Portfolio Strategy v3.7.2. "
        ...
        "For QuantData signals (IV rank, order flow, dark pool, GEX, vol skew) use the "
        "quantdata MCP server directly — it supports all tickers."
    ),
)
